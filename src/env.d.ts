...
interface ImportMetaEnv {
  ...
  /** Optional dashboard summary webhook endpoint */
  readonly ANSIVERSA_DASHBOARD_HOOK_URL?: string;

  /** Optional notifications webhook endpoint */
  readonly ANSIVERSA_NOTIFICATIONS_HOOK_URL?: string;
}
